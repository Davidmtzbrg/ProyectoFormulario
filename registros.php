...
<body>
                ...
                <div class="col-md-12">
                    <nav class="navbar navbar-expand-lg bg-light">
                        <div class="container-fluid">
                            <a class="navbar-brand" class="nav-link" href="Prospecto.php">Registros</a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="registros.php">Evaluacion De Prospectos</a>
                                    </li>
                                    <li class="nav-item">
    ...
    <section class="content">
        <div class="container">
            ...
            ?>
            <form action="controladores/actualizar.php" method="post">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            ...
                            <input autocomplete="off" class="form-control" class="text-break" name="observacion"
                                id="observacion">
                        </div>


                        <br>
                        <button type="submit" class="btn btn-success" name="Btnautorizar"
                            value="Autorizar">Autorizar</button>
                        <button type="submit" class="btn btn-danger" name="btn_rechazar">Rechazar</button>
